class EdoOracle::ViewChecker
  ...
  def initialize
    ...
    if ProvidedServices.calcentral?
      VIEW_DEPENDENCIES.concat CLC_SISEDO_VIEW_DEPENDENCIES
      VIEW_DEPENDENCIES.concat CLC_SYSADM_VIEW_DEPENDENCIES
    end
