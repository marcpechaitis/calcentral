describe FinancialAid::MyFinaidProfile do
  ...
  describe '#get_feed' do
    ...
    it 'returns the expected result' do
      ...
      expect(subject[:finaidProfile][:categories][0][:itemGroups][6][0][:values][0][:subvalue][1]).to eq '12 Units'
      expect(subject[:finaidProfile][:categories][0][:itemGroups][6][0][:values][1][:subvalue][0]).to eq 'Spring 2018'
      expect(subject[:finaidProfile][:categories][0][:itemGroups][6][0][:values][1][:subvalue][1]).to eq '12 Units'
      expect(subject[:finaidProfile][:categories][0][:itemGroups][6][0][:values][2][:subvalue][0]).to eq 'Summer 2018'
      expect(subject[:finaidProfile][:categories][0][:itemGroups][6][0][:values][2][:subvalue][1]).to eq '7 Units'
      ...
      expect(subject[:finaidProfile][:categories][1][:title]).to eq 'Terms & Conditions / Update Title IV'
    ...
    context 'when no aid year is provided' do
      ...
      it 'assumes the default aid year' do
        ...
        expect(subject[:finaidProfile][:categories][0][:itemGroups][6][0][:values][1][:subvalue][1]).to eq '16 Units'
        expect(subject[:finaidProfile][:categories][0][:itemGroups][7][0][:title]).to eq 'SHIP (Student Health Insurance Program)'
